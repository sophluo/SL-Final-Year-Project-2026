...
This project aims to use the data from the ATom missions to model $[OH]$ and compare this with the measured $[OH]$. It will also use an alternative data-driven approach of machine learning to compare with the box modelling approach. 
